...
public class IntIntMapTest {
    ...
    private static final int[] VALUES = RandomGenerator.getDefault()
        .ints(MIN_VALUE, MAX_VALUE)
        .limit(ENTRIES)
        .toArray();

    static IntIntMap newMap(int[] keys, int[] values) {
        final var map = new IntIntMap();
    ...
    public void forEachValue() {
        ...
        assertThat(values).containsExactlyInAnyOrderElementsOf(
            IntStream.of(VALUES).boxed().toList()
        );
    }
