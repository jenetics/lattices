 ...
 */
public abstract class BaseIntGrid2d<G extends BaseIntGrid2d<G>>
    implements Grid2d<IntArray, G>
{
    ...
    protected BaseIntGrid2d(
        ...
        final var ctr = (BiFunction<Structure2d, IntArray, G>)constructor;
    ...
    @Override
    public G create(final Structure2d structure, final IntArray array) {
     ...
     */
    public void swap(final BaseIntGrid2d<?> other) {
        checkSameExtent(extent(), other.extent());
     ...
     *         otherwise
     */
    public boolean equals(final BaseIntGrid2d<?> other) {
    ...
    public int hashCode() {
        ...
        forEach((i, j) -> hash[0] += Integer.hashCode(get(i, j))*17);
        return hash[0];
    }
    ...
    public boolean equals(final Object object) {
        return object == this ||
            object instanceof BaseIntGrid2d<?> grid &&
                equals(grid);
    }
