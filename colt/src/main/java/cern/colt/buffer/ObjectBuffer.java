 ...
 */
public class ObjectBuffer<T> extends cern.colt.PersistentObject implements ObjectBufferConsumer<T> {
    protected ObjectBufferConsumer<T> target;
    protected Object[] elements;

    // vars cached for speed
    protected ObjectArrayList<T> list;
     ...
     * @param capacity the number of points the buffer shall be capable of
     * holding before overflowing and flushing to the target.
     */
    public ObjectBuffer(ObjectBufferConsumer<T> target, int capacity) {
        this.target = target;
