...
class SelectedSparseObjectMatrix1D extends ObjectMatrix1D {
     ...
     * @param offset
     */
    protected SelectedSparseObjectMatrix1D(int size, AbstractIntObjectMap<Object> elements, int zero, int stride, int[] offsets, int offset) {
     ...
     */
    protected SelectedSparseObjectMatrix1D(AbstractIntObjectMap<Object> elements, int[] offsets) {
