...
public class SparseObjectMatrix1D extends ObjectMatrix1D {
     ...
     * {@link cern.colt.map.OpenIntObjectHashMap}.
     *
     * @param size the number of cells the matrix shall have.
     ...
     * @throws IllegalArgumentException if <tt>size<0</tt>.
     */
    protected SparseObjectMatrix1D(int size, AbstractIntObjectMap<Object> elements, int offset, int stride) {
     ...
     * coordinate is within bounds.</b> Precondition (unchecked): <tt>index&lt;0
     * || index&gt;=size()</tt>.
     *
