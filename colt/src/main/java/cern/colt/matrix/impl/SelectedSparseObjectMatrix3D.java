 ...
 * <p>
 * <tt>memory [bytes] =
 * 4*(sliceIndexes.length+rowIndexes.length+columnIndexes.length)</tt>.
...
class SelectedSparseObjectMatrix3D extends ObjectMatrix3D {
     ...
     * @param sliceOffsets The slice offsets of the cells that shall be
     * visible.
     * @param rowOffsets The row offsets of the cells that shall be visible.
     * @param columnOffsets The column offsets of the cells that shall be
     * visible.
     */
    protected SelectedSparseObjectMatrix3D(AbstractIntObjectMap<Object> elements, int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param rows the number of rows the matrix shall have.
     * @param columns the number of columns the matrix shall have.
     * @throws IllegalArgumentException if <tt>(Object)rows*slices >
