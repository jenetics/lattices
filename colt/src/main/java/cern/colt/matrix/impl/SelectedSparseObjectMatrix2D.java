...
class SelectedSparseObjectMatrix2D extends ObjectMatrix2D {
     ...
     * @param offset
     */
    protected SelectedSparseObjectMatrix2D(int rows, int columns, AbstractIntObjectMap<Object> elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedSparseObjectMatrix2D(AbstractIntObjectMap<Object> elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param rows the number of rows the matrix shall have.
     * @param columns the number of columns the matrix shall have.
     * @throws IllegalArgumentException if <tt>(Object)columns*rows >
     ...
     * @throws IllegalArgumentException if <tt>column < 0 || column >=
     * columns()</tt>.
     * @see #viewRow(int)
     */
