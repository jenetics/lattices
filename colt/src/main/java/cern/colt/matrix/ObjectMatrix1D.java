...
public abstract class ObjectMatrix1D extends AbstractMatrix1D {
     ...
     * a(i-1), f(get(i)) )</tt> and terminators are <tt>a(1) == f(get(0)),
     * a(0)==null</tt>.
     * <p>
     * <b>Example:</b>
     * <pre>
     ...
     * f(get(i),other.get(i)) )</tt> and terminators are <tt>a(1) ==
     * f(get(0),other.get(0)), a(0)==null</tt>.
     * <p>
     * <b>Example:</b>
     * <pre>
     * cern.jet.math.Functions F = cern.jet.math.Functions.functions;
     ...
     * function(x[i])</tt>. (Iterates downwards from <tt>[size()-1]</tt> to
     * <tt>[0]</tt>).
     * <p>
     * <b>Example:</b>
     * <pre>
     ...
     */
    public void getNonZeros(IntArrayList indexList, ObjectArrayList<Object> valueList) {
     ...
     * based, as usual. In other words, legal coordinates of the view are <tt>0
     * .. view.size()-1==width-1</tt>. As usual, any attempt to access a cell at
     * other coordinates will throw an <tt>IndexOutOfBoundsException</tt>.
     *
     * @param index The index of the first cell.
     * @param width The width of the range.
     * @return the new view.
     * @throws IndexOutOfBoundsException if <tt>index<0 || width<0 ||
     * index+width>size()</tt>.
     */
     ...
     * holding the indicated cells. There holds <tt>view.size() ==
     * indexes.length</tt> and <tt>view.get(i) == this.get(indexes[i])</tt>.
     ...
     * view. To indicate that <i>all</i> cells shall be visible, simply set this
     * parameter to <tt>null</tt>.
     * @return the new view.
     * @throws IndexOutOfBoundsException if <tt>!(0 <= indexes[i] < size())</tt>
     * for any <tt>i=0..indexes.length()-1</tt>.
     */
     ...
     * information, see
     * {@link cern.colt.matrix.objectalgo.Sorting#sort(ObjectMatrix1D)}. For
     ...
     * <tt>[size()-1]</tt> to <tt>[0]</tt>, as demonstrated by this snippet:
     * <pre>
     * for (int i=size(); --i >=0;) {
