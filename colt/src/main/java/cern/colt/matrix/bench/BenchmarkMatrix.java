 ...
 * overall help</a> on usage type <tt>java
 * cern.colt.matrix.bench.BenchmarkMatrix -help</tt>. To get help on usage of a
 * given command, type <tt>java cern.colt.matrix.bench.BenchmarkMatrix -help
 * &lt;command&gt;</tt>. Here is the <a href="doc-files/usage_dgemm.txt">help
 * ouput for the dgemm</a> command.
 * <a href="../doc-files/dgemmColt1.0.1ibm1.3LxPIII_2.txt">Here</a> is a sample
 * result.
 * For more results see the <a
...
public class BenchmarkMatrix {
    ...
    protected static Double2DProcedure funSOR5() {
        return new Double2DProcedure() {
            ...
            final cern.colt.function.Double9Function function = new cern.colt.function.Double9Function() {
                public double apply(double a00, double a01, double a02, double a10, double a11, double a12, double a20, double a21, double a22) {
