 ...
 */
public abstract class AbstractIntObjectMap<T> extends AbstractMap<Integer, T> {
    ...
    public AbstractIntObjectMap<T> copy() {
        return (AbstractIntObjectMap<T>) clone();
    }
     ...
     */
    public void pairsMatching(final IntObjectProcedure condition, final IntArrayList keyList, final ObjectArrayList<T> valueList) {
        keyList.clear();
        valueList.clear();
     ...
     * @param valueList the list to be filled with values, can have any size.
     */
    public void pairsSortedByKey(final IntArrayList keyList, final ObjectArrayList<T> valueList) {
        keys(keyList);
        keyList.sort();
    ...
    public void pairsSortedByValue(final IntArrayList keyList, final ObjectArrayList<T> valueList) {
        keys(keyList);
        values(valueList);
