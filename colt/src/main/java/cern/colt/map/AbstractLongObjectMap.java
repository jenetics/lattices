 ...
 */
public abstract class AbstractLongObjectMap<T> extends AbstractMap<Long, T> {
    ...
    public AbstractLongObjectMap<T> copy() {
        return (AbstractLongObjectMap<T>) clone();
    }
    ...
    public boolean equals(Object obj) {
        ...
        @SuppressWarnings("unchecked")
        final AbstractLongObjectMap<T> other = (AbstractLongObjectMap<T>) obj;
     ...
     */
    public void pairsMatching(final LongObjectProcedure condition, final LongArrayList keyList, final ObjectArrayList<T> valueList) {
        keyList.clear();
        valueList.clear();
     ...
     * @param valueList the list to be filled with values, can have any size.
     */
    public void pairsSortedByKey(final LongArrayList keyList, final ObjectArrayList<T> valueList) {
        keys(keyList);
        keyList.sort();
    ...
    public void pairsSortedByValue(final LongArrayList keyList, final ObjectArrayList<T> valueList) {
        keys(keyList);
        values(valueList);
     ...
     * @return the values.
     */
    public ObjectArrayList<T> values() {
        ObjectArrayList<T> list = new ObjectArrayList<>(size());
        values(list);
        return list;
    }
     ...
     * @param list the list to be filled, can have any size.
     */
    public void values(final ObjectArrayList<T> list) {
        list.clear();
        forEachKey(new LongProcedure() {
            public boolean apply(long key) {
                list.add(get(key));
