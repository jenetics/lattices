...
public abstract class AbstractList<T> extends AbstractCollection<T> {
	 ...
	 * tuned quicksort, adapted from Jon L. Bentley and M. Douglas McIlroy's
	 ...
	 * any superfluous internal memory. Use method <tt>trimToSize</tt> to
	 * release superfluous internal memory.
	 *
