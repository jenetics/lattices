...
/**
 * Adapter that permits an {@link cern.colt.list.AbstractFloatList} to be viewed
 ...
 * primitive values which are then stored in the backing templated list.
 * Getter methods return <tt>java.lang.Float</tt> objects.
 */
public class FloatListAdapter extends java.util.AbstractList<Float> {
