...
/**
 * Adapter that permits an {@link cern.colt.list.ObjectArrayList} to be viewed
 ...
 */
public class ObjectListAdapter<T> extends java.util.AbstractList<T> {
    protected ObjectArrayList<T> content;

    /**
     * Constructs a list backed by the specified content list.
     */
    public ObjectListAdapter(ObjectArrayList<T> content) {
