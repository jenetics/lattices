...
public class Converter {
    ...
    public String toString(IAxis axis) {
        String buf = "Range: [" + axis.lowerEdge() + "," + axis.upperEdge() + ")" + ", Bins: " + axis.bins() + ", Bin edges: " + toString(edges(axis)) + "\n";
        return buf;
    }
    ...
    public String toString(IHistogram2D h) {
        ...
        String sep = System.getProperty("line.separator");
        int[] minMaxBins = h.minMaxBins();
        String title = h.title() + ":" + sep + "   Entries=" + form(f, h.entries()) + ", ExtraEntries=" + form(f, h.extraEntries()) + sep + "   MeanX=" + form(f, h.meanX()) + ", RmsX=" + form(f, h.rmsX()) + sep + "   MeanY=" + form(f, h.meanY()) + ", RmsY=" + form(f, h.rmsX()) + sep + "   MinBinHeight=" + form(f, h.binHeight(minMaxBins[0], minMaxBins[1])) + ", MaxBinHeight=" + form(f, h.binHeight(minMaxBins[2], minMaxBins[3])) + sep +
